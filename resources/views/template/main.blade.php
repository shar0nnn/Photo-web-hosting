    ...
    <div class="layout-container">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-1 pt-1">
                            <div class="row">
                                <div class="col mb-1">
                                    {{--                                                        <label for="nameBasic" class="form-label">Назва</label>--}}
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Public photos -->
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::currentRouteName() === 'main' ? 'active' : '' }}">
                ...
                @auth()
                    <!-- User photos -->
                    <li class="menu-item {{ \Illuminate\Support\Facades\Route::currentRouteName() === 'user.photos' ? 'active' : '' }}">
                        <a href="{{ route('user.photos') }}" class="menu-link">
                ...
                <!-- Users list -->
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::currentRouteName() === 'users.index' ? 'active' : '' }}">
                ...
                <!-- Groups list -->
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::currentRouteName() === 'groups.index' ? 'active' : '' }}">
